/** @typedef {import("./cassava_min_20250406.d.ts").CassavaGridElement} CassavaGridElement */
...
function loadCassava() {
  ...
  script.src = 'https://www.asukaze.net/soft/cassava/js/cassava_min_20250406.js';
