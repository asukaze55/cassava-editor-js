...
<!-- JavaScript を読み込む -->
<script src="https://www.asukaze.net/soft/cassava/js/cassava_min_20251228.js"></script>
</body>
</html>
```
...
型の定義ファイルは https://www.asukaze.net/soft/cassava/js/cassava_min_20251228.d.ts で公開しています。
